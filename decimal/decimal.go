...
func (d *Decimal) UnmarshalBSON(decimalBytes []byte) error {
	return d.UnmarshalJSON(decimalBytes)
}
...
func (d *Decimal) SetBSON(raw bson.Raw) error {
	...
	if err = raw.Unmarshal(&strData); err != nil {
		...
		if *d, err = NewFromString(d128.String()); err != nil {
			fmt.Printf("decimal.NewFromString return error [%v]\n", err.Error())
			panic(err.Error())
		}
	} else {
		if err = d.UnmarshalJSON([]byte(strData)); err != nil {
...
func (d NullDecimal) MarshalBSON() ([]byte, error) {
	return d.MarshalJSON()
}

func (d *NullDecimal) UnmarshalBSON(decimalBytes []byte) error {
	return d.UnmarshalJSON(decimalBytes)
}
...
func (d NullDecimal) MarshalBSONValue() (bsontype.Type, []byte, error) {
	...
	return bsontype.String, []byte(d.Decimal.String()), nil
}

func (d *NullDecimal) UnmarshalBSONValue(_ bsontype.Type, data []byte) error {
	return d.UnmarshalJSON(data)
}
...
func (d *NullDecimal) SetBSON(raw bson.Raw) error {
	...
	if err = raw.Unmarshal(&strData); err != nil {
		...
		if d.Decimal, err = NewFromString(d128.String()); err != nil {
			fmt.Printf("decimal.NewFromString return error [%v]\n", err.Error())
			panic(err.Error())
		}
	} else {
